...
xmlhttp.open("GET","NovoDetaljnije.php?txt="+stringic,true);
xmlhttp.send();
}
...
xmlhttp.open("POST","komentarinovi.php",true);
xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xmlhttp.send("id="+stringic);
}
...
xmlhttp.open("GET","MajiceDugiRukavZene.html",true);
xmlhttp.send();
}
