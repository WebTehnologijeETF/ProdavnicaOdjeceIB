function DodavanjeProizvoda()
{
	...
	var Proizvod={naziv:naziv1,opis:opis1,slika:slika1,kolicina:kolicina1,cijena:cijena1,dostupnost:dostupnost1};
...
xmlhttp.onreadystatechange=function()
  ...
  xmlhttp.send("akcija="+"dodavanje"+"&proizvod="+Proizvodjson+ "&brindexa="+"16266");
